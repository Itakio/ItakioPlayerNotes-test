...
if event == "ADDON_LOADED" and name == "ItakioPlayerNotes" then
	...
	DEFAULT_CHAT_FRAME:AddMessage("IPN loaded. '/ipn' or hit minimap button to open main frame, or '/ipn tgt' to make a new note on your target or edit target's existing note (useful in macros)")
